...
from fetchTime import getTime
from fetchLocation import getLocation


def calculate_risk(kindofinfo):
    ...
    calculated_risk.input['time'] = 5
    calculated_risk.input['location'] = 5
